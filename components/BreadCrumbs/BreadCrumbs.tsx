				...
				<ul>
					...
					{typeof currentRoute === 'object' && currentRoute.countries &&
						<li className={lastItemRoute[1] == currentRoute.countries ? styles["active"] : ''}>
							<Link href={
									{pathname: Constants.paths.pathCountries, query: {countries: currentRoute.countries}}
					...
					{typeof currentRoute === 'object' && currentRoute.cities &&
						<li className={lastItemRoute[1] == currentRoute.cities ? styles["active"] : ''}>
							<Link href={
									{pathname: Constants.paths.pathAllWithCities, query: {countries: currentRoute.countries, cities: currentRoute.cities}}
					...
					{typeof currentRoute === 'object' && currentRoute.interests &&
						<li className={lastItemRoute[1] == currentRoute.interests ? styles["active"] : ''}>
							<Link href={
									{pathname: Constants.paths.pathAllWithInterests, query: {countries: currentRoute.countries, cities: currentRoute.cities, interests: currentRoute.interests}}
					...
					{typeof currentRoute === 'object' && currentRoute.categories &&
						<li className={lastItemRoute[1] == currentRoute.categories ? styles["active"] : ''}>
							<Link href={
									{pathname: Constants.paths.pathAllWithCategories, query: {countries: currentRoute.countries, cities: currentRoute.cities, interests: currentRoute.interests, categories: currentRoute.categories}}
								}><Image src={iconCategory} alt="icon" width={24} height={24} />{text[ML.key.category]}
							</Link>
						</li>
					}
					{currentRoute === Constants.paths.pathProposeMeeting &&
					...
					{currentRoute === Constants.paths.pathYourMeetings &&
						<li className={styles["active"]}>
							<Link href={
									{pathname: currentRoute}
